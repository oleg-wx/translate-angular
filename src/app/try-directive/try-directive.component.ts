...
@Component({
  ...
  template: `
    ...
    <div
      ...
      [values]="{ count: 3 }"
      [fallback]="{ value: 'Count: \${count}', plural: { count: [['=3', 'three']] } }"
    ></div>
...
export class TryDirectiveComponent {
  langs = ['en-US', 'ru-RU'];
  selectedLang = this.root.lang;
  dynamicKey = 'hello_world';

  constructor(private root: TranslateRootService) {}
